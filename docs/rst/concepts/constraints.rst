...
~~~~~~~~~~~~~~~~~~~~~~~
Flexible electricity demand shifting balance if :math:`\peledemflexible_{\demandindex} == 1.0` and :math:`\peledemshiftedsteps_{\demandindex} > 0.0` («``eEleDemandShiftBalance``»)
...
~~~~~~~~~~~~~~~~~~~~~~~~~
Flexible electricity demand share of total demand if :math:`\peledemflexible_{\demandindex} == 1.0` and :math:`\peledemshiftedsteps_{\demandindex} > 0.0` («``eEleDemandShifted``»)
