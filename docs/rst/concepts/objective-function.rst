...
.. math::
    ...
    \freqcontdisturbrevenue_{p,s,n} = \sum_{g \in \mathcal{G}^{e,nr}} \left( (\pelefcrdupprice_{p,s,n} \pfactorone \cdot \velefcrdupbid_{p,s,n,g} + \pelefcrddwprice_{p,s,n} \pfactorone \cdot \velefcrddwbid_{p,s,n,g}) \cdot (1 + \pelemarketmoms_{\text{Retailer}(g)}) \right)

where :math:`\text{Retailer}(g)` is the retailer associated with generator :math:`g`.
...
.. math::
   ...
   C^{tax,e}_{p,s} = \sum_{r \in \mathcal{R}^{e}} \left( \text{pEleRetEnergyTax}_{r} \pfactorone (1 + \pelemarketmoms_{r}) \sum_{n \in \mathcal{T}} \velemarketbuy_{p,s,n,r} \right)
